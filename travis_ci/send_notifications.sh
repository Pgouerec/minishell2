#!/bin/bash
# @Author: gouerec_p
# @Date:   2020-03-10 18:54:56
# @Last Modified by:   gouerec_p
# @Last Modified time: 2020-03-10 18:55:38
# 
if [ -z "$2" ]; then
...
(curl --fail --progress-bar -A "TravisCI-Webhook" -H Content-Type:application/json -H X-Author:########## -d "${WEBHOOK_DATA//    / }" "$2" \
